        ...
        >
            <div className="hidden lg:block w-full h-full">
                <div className="flex flex-row items-center justify-between w-full h-full">
                    <div className="cursor-pointer w-[250px] h-full px-8 flex flex-col justify-center rounded-full hover:bg-gray-100">
                        <p className="text-xs font-semibold">Donde</p>
                        <p className="text-sm">Explora destinos</p>
                    </div>

                    <div className="cursor-pointer h-full px-8 flex flex-col justify-center rounded-full hover:bg-gray-100">
                        <p className="text-xs font-semibold">Llegada</p>
                        <p className="text-sm">Agrega fechas</p>
                    </div>
